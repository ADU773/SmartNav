 ...
 *
 * Runs unchanged on the main thread or inside a worker. The Panoramic Viewer
 * now uses the equirectangular stitcher (utils/stitchEquirectangular.js); this
 * planar version is kept for flat, non-360 strips.
 *
